...
struct SendView: View {
    ...
    func addItem(){
        let item = TransactionItemDataModel(defaultImage: "t.circle.fill", operationOptionImage: .send, currentTimeAndDate: Date(), userTransfers: Double(finalNetSalary) ?? 0.00)
        context.insert(item)
    }
    var body: some View {
        VStack {
...
#Preview {
    SendView(walletText: "3434321143667")
}
